 ...
 */
public class WaterLevelSubsystemShadowingFunction extends ShadowingModelFunction {

    public WaterLevelSubsystemShadowingFunction(String id) {
        super(id);
    }
            ...
            adaptersPhysicalAssetDescriptionMap.values().forEach(pad -> {
                pad.getProperties().forEach(property -> {
                    try {
                        ...
                        } else if (property.getKey().equals("water-distance")){
                            this.digitalTwinState.createProperty(new DigitalTwinStateProperty<>(property.getKey(),(Float) property.getInitialValue()));
                            this.observePhysicalAssetProperty(property);
